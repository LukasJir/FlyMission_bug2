#include "cpp_fly_mission_bug2/fly_mission_bug2.hpp" 
...
namespace mission
{
    ...
    void FlyMission::cbDepth(const sensor_msgs::msg::Image::SharedPtr msg) 
    {
        ...
        if(in_air && (state != 5) && (depthValue_center < depth_threshold_center || depthValue_left < depth_threshold_side || depthValue_right < depth_threshold_side)){    //detekce prekazky
